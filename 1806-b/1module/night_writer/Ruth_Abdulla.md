...
Repo: https://github.com/abdullaqudrat/night_writer
...
* When you find yourself repeating similar/same instance variables, think about creating a class just to hold that information.
...
* Awesome job with naming, keep it up!
...
* Make a few more commits next time
* Include more infor on PR comments
