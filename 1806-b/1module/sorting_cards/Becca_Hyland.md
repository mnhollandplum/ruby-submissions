...
Repo: https://github.com/BeccaHyland/sorting_cards

## Functionality: 2

Notes:

* On the round.record_guess, you should be updating the deck so that the current_card is correct.
...
* Think about using enumeration to get the correct_guesses.
* Review the if/else statement syntax.
