...
- Evaluator: Dione
- Repo URL: https://github.com/justinetroyke/little-shop-redux

Notes:

- Using sort_by rather than utilizing AR
- Need to work on feature testing first rather than after
