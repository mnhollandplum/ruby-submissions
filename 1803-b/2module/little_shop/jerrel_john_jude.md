...
- Repo URL: https://github.com/JerrelMitchell/little-shop-redux/

Notes:

- 90 tests, unknown coverage
- missing a few little features on two user stories
- calling AR from View
- don't mix model testing into feature tests
- no PM tool
