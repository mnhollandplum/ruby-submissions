...
### GitHub Repo: https://github.com/Jliv316/job-tracker

### Notes:

- deleting a job won't work if comments exist
- missing links
  - add/edit jobs from company
  - category show page from category index
- jobs show page doesn't show city/interest but sorting shows relevant data
- dashboard list by interest should be sorted in descending order
- controller for jobs#index is complicated
