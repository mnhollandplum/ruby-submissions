...
- some styling is hard to view
- no link to get to a company's jobs
- /jobs page doesn't work
- job sorting not always working
- one instance of using Ruby to reverse a collection instead of sorting in descending order from AR
