...
- Repo URL: https://github.com/TristanB17/little-shop-redux

Notes:

- 97.5% coverage, 80 expectations
- some pages not styled
- one or two minor features not working (editing an invoice)
- testing looks awesome
