...
- Repo URL: https://github.com/wehttamclan/little-shop-redux

Notes:

- 100% test coverage
- some styling not complete
- add item to show page breaks
- a couple of double-hits to database from model methods
- one model method doing a ton of ruby
